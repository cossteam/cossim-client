				...
				function (_dereq_, module, exports) {
					;(function (global) {
						...
						function url(uri, loc) {
							...
							// define href
							obj.href =
								obj.protocol + '://' + obj.host + (loc && loc.port == obj.port ? '' : ':' + obj.port)
				...
				function (_dereq_, module, exports) {
					;(function (global) {
						...
						function Socket(uri, opts) {
							...
							this.secure =
								null != opts.secure ? opts.secure : global.location && 'https:' == location.protocol
							...
							this.port =
								opts.port || (global.location && location.port ? location.port : this.secure ? 443 : 80)
