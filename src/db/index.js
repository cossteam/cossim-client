...
const TABLES = {
	...
	chats: `
		...
		msg_id`,
	// 用户私聊消息
	user_msgs: `++id, &msg_id, msg_is_self, msg_read_status ,msg_type, msg_content, msg_send_time, meg_sender_id, dialog_id, msg_send_state`,
	// 用户群聊消息
	group_msgs: `++id, &msg_id, msg_is_self, msg_read_status ,msg_type, msg_content, msg_send_time, meg_sender_id, group_id, dialog_id, msg_send_state`,
	// 会话列表
