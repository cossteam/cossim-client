					...
					<div className="w-full flex flex-col justify-center items-center">
						<div className="mb-6 w-full grid grid-cols-5 gap-6">
							...
							<div
                                ...
                                onClick={() => f7router.navigate(`/group_info/${GroupId}/member/${MemberListType.NOTMEMBER}`)}
							>
							...
							{identity && (
								<div
									className="w-12 h-12 flex flex-col justify-center items-center border-dashed border-[1px] border-gray-400 text-gray-500 rounded-lg"
                                    onClick={() => f7router.navigate(`/group_info/${GroupId}/member/${MemberListType.MEMBER}`)}
								>
						...
						{members.length > 23 && (
							<div className="mb-1">
								<span
                                    ...
                                    onClick={() => f7router.navigate(`/group_info/${GroupId}/member/${MemberListType.MEMBERSHOW}`)}
								>
									查看更多群成员
								</span>
							</div>
