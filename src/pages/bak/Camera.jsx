...
export default function Camera() {
	...
	return (
		<Popup swipeToClose="to-bottom" onPopupOpened={initCamera} onPopupClosed={stopCamera}>
			<View>
					...
					{!errored ? (
						...
						<PageContent>
							<div className="camera-error">
								Your device does not support camera API or you did not provide permission to use the
								camera
							</div>
						</PageContent>
					)}
