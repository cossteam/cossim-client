...
import { List, ListItem, Navbar, Page, BlockTitle, BlockFooter } from 'framework7-react'
import './Status.less'
...
export default function StatusPrivacy() {
	...
	return (
		<Page className="status-page">
			<Navbar className="status-navbar" title="Status Privacy" backLink="Back" />
			<BlockTitle
				style={{
			...
			<BlockFooter>Changes to your privacy settings won't affect status updates you've sent alredy.</BlockFooter>
		</Page>
	)
}
